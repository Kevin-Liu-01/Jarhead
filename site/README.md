...
- Run: `pnpm -C site dev` (http://localhost:3939); check: `pnpm -C site typecheck` and `pnpm -C site check:install` (the installer against the README, `scripts/check-install.sh`); ship: `pnpm -C site build`.
