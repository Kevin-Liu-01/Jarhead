...
/**
 * JarheadMark (BrandMarks.swift:446-466; facts-orb.md §1.9): the faceless dithered disc at 14 / 20 / 24 px,
 ...
 */
export function Mark({ size = 20, quiet, className }: { size?: 14 | 20 | 24; quiet?: boolean; className?: string }): ReactElement {
