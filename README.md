...
<table>
  ...
  <tr>
    <td><img src="docs/media/notch-island.png" alt="The island: Listening, the transport dot, Stop and Mute, the last line"></td>
    <td><img src="docs/media/notch-island-working.png" alt="The island while acting: Working · 0:02"></td>
  </tr>
  <tr>
    <td>The island under the pointer: transport, Stop, Mute.</td>
