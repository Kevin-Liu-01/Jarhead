...
export const DRAW_SPECS: readonly ToolSpec[] = [
  ...
  {
    name: "show_rect",
    description: "Frame a region of Kevin's screen with a fading rectangle — the panel, the field, the row to look at. The blob traces the frame (quick: true stamps it instantly). Teaching only. rect is [x, y, w, h] in pixels of the last screenshot.",
